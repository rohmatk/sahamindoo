...
_mathjax_config = ...
def to_html(fig, config=..., auto_play=..., include_plotlyjs=..., include_mathjax=..., post_script=..., full_html=..., animation_opts=..., default_width=..., default_height=..., validate=..., div_id=...): # -> str:
    """
