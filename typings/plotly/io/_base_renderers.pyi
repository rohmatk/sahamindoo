...
class ImageRenderer(MimetypeRenderer):
    ...
    def to_mimebundle(self, fig_dict): # -> dict[Any, str]:
        ...
...
class HtmlRenderer(MimetypeRenderer):
    ...
    mime type: 'text/html'
    """
    def __init__(self, connected=..., full_html=..., global_init=..., config=..., auto_play=..., post_script=..., animation_opts=..., include_plotlyjs=...) -> None:
        ...
...
class NotebookRenderer(HtmlRenderer):
    ...
    mime type: 'text/html'
    """
    def __init__(self, connected=..., config=..., auto_play=..., post_script=..., animation_opts=..., include_plotlyjs=...) -> None:
        ...
