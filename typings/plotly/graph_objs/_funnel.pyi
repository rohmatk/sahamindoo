...
class Funnel(_BaseTraceType):
    ...
    def __init__(self, arg=..., alignmentgroup=..., cliponaxis=..., connector=..., constraintext=..., customdata=..., customdatasrc=..., dx=..., dy=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hovertemplate=..., hovertemplatefallback=..., hovertemplatesrc=..., hovertext=..., hovertextsrc=..., ids=..., idssrc=..., insidetextanchor=..., insidetextfont=..., legend=..., legendgroup=..., legendgrouptitle=..., legendrank=..., legendwidth=..., marker=..., meta=..., metasrc=..., name=..., offset=..., offsetgroup=..., opacity=..., orientation=..., outsidetextfont=..., selectedpoints=..., showlegend=..., stream=..., text=..., textangle=..., textfont=..., textinfo=..., textposition=..., textpositionsrc=..., textsrc=..., texttemplate=..., texttemplatefallback=..., texttemplatesrc=..., uid=..., uirevision=..., visible=..., width=..., x=..., x0=..., xaxis=..., xhoverformat=..., xperiod=..., xperiod0=..., xperiodalignment=..., xsrc=..., y=..., y0=..., yaxis=..., yhoverformat=..., yperiod=..., yperiod0=..., yperiodalignment=..., ysrc=..., zorder=..., **kwargs) -> None:
        """
