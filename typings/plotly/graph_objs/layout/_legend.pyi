...
class Legend(_BaseLayoutHierarchyType):
    ...
    @property
    def indentation(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @property
    def maxheight(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    def __init__(self, arg=..., bgcolor=..., bordercolor=..., borderwidth=..., entrywidth=..., entrywidthmode=..., font=..., groupclick=..., grouptitlefont=..., indentation=..., itemclick=..., itemdoubleclick=..., itemsizing=..., itemwidth=..., maxheight=..., orientation=..., title=..., tracegroupgap=..., traceorder=..., uirevision=..., valign=..., visible=..., x=..., xanchor=..., xref=..., y=..., yanchor=..., yref=..., **kwargs) -> None:
        """
