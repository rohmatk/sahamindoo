...
from . import annotation, coloraxis, geo, grid, hoverlabel, legend, map, mapbox, newselection, newshape, polar, scene, selection, shape, slider, smith, template, ternary, title, updatemenu, xaxis, yaxis
