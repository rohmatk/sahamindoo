...
class Shape(_BaseLayoutHierarchyType):
    ...
    @property
    def x0shift(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @property
    def x1shift(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @property
    def y0shift(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @property
    def y1shift(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    def __init__(self, arg=..., editable=..., fillcolor=..., fillrule=..., label=..., layer=..., legend=..., legendgroup=..., legendgrouptitle=..., legendrank=..., legendwidth=..., line=..., name=..., opacity=..., path=..., showlegend=..., templateitemname=..., type=..., visible=..., x0=..., x0shift=..., x1=..., x1shift=..., xanchor=..., xref=..., xsizemode=..., y0=..., y0shift=..., y1=..., y1shift=..., yanchor=..., yref=..., ysizemode=..., **kwargs) -> None:
        """
