...
class Pattern(_BaseTraceHierarchyType):
    ...
    @property
    def pathsrc(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    def __init__(self, arg=..., bgcolor=..., bgcolorsrc=..., fgcolor=..., fgcolorsrc=..., fgopacity=..., fillmode=..., path=..., pathsrc=..., shape=..., shapesrc=..., size=..., sizesrc=..., solidity=..., soliditysrc=..., **kwargs) -> None:
        """
