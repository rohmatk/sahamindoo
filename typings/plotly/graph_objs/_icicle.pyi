...
class Icicle(_BaseTraceType):
    ...
    def __init__(self, arg=..., branchvalues=..., count=..., customdata=..., customdatasrc=..., domain=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hovertemplate=..., hovertemplatefallback=..., hovertemplatesrc=..., hovertext=..., hovertextsrc=..., ids=..., idssrc=..., insidetextfont=..., labels=..., labelssrc=..., leaf=..., legend=..., legendgrouptitle=..., legendrank=..., legendwidth=..., level=..., marker=..., maxdepth=..., meta=..., metasrc=..., name=..., opacity=..., outsidetextfont=..., parents=..., parentssrc=..., pathbar=..., root=..., sort=..., stream=..., text=..., textfont=..., textinfo=..., textposition=..., textsrc=..., texttemplate=..., texttemplatefallback=..., texttemplatesrc=..., tiling=..., uid=..., uirevision=..., values=..., valuessrc=..., visible=..., **kwargs) -> None:
        """
