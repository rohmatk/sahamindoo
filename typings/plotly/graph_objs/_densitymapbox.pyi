...
class Densitymapbox(_BaseTraceType):
    ...
    def __init__(self, arg=..., autocolorscale=..., below=..., coloraxis=..., colorbar=..., colorscale=..., customdata=..., customdatasrc=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hovertemplate=..., hovertemplatefallback=..., hovertemplatesrc=..., hovertext=..., hovertextsrc=..., ids=..., idssrc=..., lat=..., latsrc=..., legend=..., legendgroup=..., legendgrouptitle=..., legendrank=..., legendwidth=..., lon=..., lonsrc=..., meta=..., metasrc=..., name=..., opacity=..., radius=..., radiussrc=..., reversescale=..., showlegend=..., showscale=..., stream=..., subplot=..., text=..., textsrc=..., uid=..., uirevision=..., visible=..., z=..., zauto=..., zmax=..., zmid=..., zmin=..., zsrc=..., **kwargs) -> None:
        """
