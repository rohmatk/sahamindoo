...
class Sunburst(_BaseTraceType):
    ...
    def __init__(self, arg=..., branchvalues=..., count=..., customdata=..., customdatasrc=..., domain=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hovertemplate=..., hovertemplatefallback=..., hovertemplatesrc=..., hovertext=..., hovertextsrc=..., ids=..., idssrc=..., insidetextfont=..., insidetextorientation=..., labels=..., labelssrc=..., leaf=..., legend=..., legendgrouptitle=..., legendrank=..., legendwidth=..., level=..., marker=..., maxdepth=..., meta=..., metasrc=..., name=..., opacity=..., outsidetextfont=..., parents=..., parentssrc=..., root=..., rotation=..., sort=..., stream=..., text=..., textfont=..., textinfo=..., textsrc=..., texttemplate=..., texttemplatefallback=..., texttemplatesrc=..., uid=..., uirevision=..., values=..., valuessrc=..., visible=..., **kwargs) -> None:
        """
