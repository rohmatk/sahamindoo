...
class Image(_BaseTraceType):
    ...
    def __init__(self, arg=..., colormodel=..., customdata=..., customdatasrc=..., dx=..., dy=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hovertemplate=..., hovertemplatefallback=..., hovertemplatesrc=..., hovertext=..., hovertextsrc=..., ids=..., idssrc=..., legend=..., legendgrouptitle=..., legendrank=..., legendwidth=..., meta=..., metasrc=..., name=..., opacity=..., source=..., stream=..., text=..., textsrc=..., uid=..., uirevision=..., visible=..., x0=..., xaxis=..., y0=..., yaxis=..., z=..., zmax=..., zmin=..., zorder=..., zsmooth=..., zsrc=..., **kwargs) -> None:
        """
