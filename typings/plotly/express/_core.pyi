...
def configure_map(args, fig, orders): # -> None:
    ...
...
def to_named_series(x, name=..., native_namespace=...): # -> Series[Any]:
    """Assuming x is list-like or even an existing Series, returns a new Series named `name`."""
    ...

def process_args_into_dataframe(args, wide_mode, var_name, value_name, is_pd_like, native_namespace):
    """
...
def get_groups_and_orders(args, grouper): # -> tuple[dict[tuple[Any, ...], Any | DataFrame[Any]] | dict[tuple[Any | str, ...], DataFrame[Any]], Any | dict[Any, Any]]:
    """
